export default function Resources() {
  return (
    <div className="mt-[80px] max-w-5xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-8 text-center">Resources</h1>

      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">Becoming an Official</h2>
        <img
        ...
        />
        <div className="prose max-w-none mx-auto text-gray-800 bg-white bg-opacity-90 rounded p-4">
...
<h3 className="text-lg font-bold mt-6 mb-2">Assistant Judge</h3>
<ul>
...
<br />
<h3 className="text-lg font-bold mt-6 mb-2">Assistant Scorer</h3>
<ul>
...
<br />
<h3 className="text-lg font-bold mt-6 mb-2">Assistant Driver</h3>
<ul>
...
<br />
<h3 className="text-lg font-bold mt-6 mb-2">Safety Coordinator</h3>
<ul>
...
<h3 className="text-lg font-bold mt-6 mb-2">What to do at a tournament and how to actually obtain your rating</h3>
<ol>
...
<br />
<h3 className="text-lg font-bold mt-6 mb-2">How to make sure credit is earned for working a tournament</h3>
<ul>
...
<br />
<h3 className="text-lg font-bold mt-6 mb-2">Team Midwest Official’s Incentive</h3>
...
<br />
<h3 className="text-lg font-bold mt-6 mb-2">Points Breakdown</h3>
<ul>
...
<br />
<h3 className="text-lg font-bold mt-6 mb-2">Additional Information</h3>
<ul>
...
<br />
<h3 className="text-lg font-bold mt-6 mb-2">Maintaining Assistant Ratings</h3>
<ul>
  <li>You need to work four tournaments every two years in order to maintain your rating.</li>
</ul>
<br />
For more information, read: USA Waterski’s Writeup on Becoming a Judge<br /><br />
To see exactly what needs to be done to earn each rating, start by downloading the Official’s Applications below:<br />
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">Places To Ski</h2>
        <div className="text-gray-500 italic">No locations listed yet. Please check back soon or contact us if you have recommendations!</div>
      </section>
    </div>
  );
}
